...
void UCPWeaponComponent::OnEmptyClip(ACPBaseWeapon* AmmoEmptyWeapon)
{
...
bool UCPWeaponComponent::GetCurrentWeaponUIData(FWeaponUIData& UIData) const
{
    if (CurrentWeapon)
    {
...
bool UCPWeaponComponent::GetCurrentWeaponAmmoData(FAmmoData& AmmoData) const
{
    if (CurrentWeapon)
    {
...
bool UCPWeaponComponent::TryToAddAmmo(TSubclassOf<ACPBaseWeapon> WeaponType, int32 ClipsAmount)
{
    for (const auto Weapon : Weapons)
    {
